...
export function MascotDog() {
  ...
  useEffect(() => {
    ...
    const updatePosition = () => {
      frame = 0;
      setScrollOffset(Math.min(84, Math.max(-6, window.scrollY * 0.07)));
    };
  ...
  return (
    <div className={`mascotDogWrap mascotDogMode-${renderedMode} ${reducedMotion ? 'mascotDogReduced' : ''}`} style={{ transform: `translate3d(0, ${scrollOffset}px, 0)` }}>
